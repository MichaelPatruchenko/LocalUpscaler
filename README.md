...
| ![До](docs/screenshots/200x200.jpg) **Смешивание** — список вариантов + 25 режимов наложения | ![После](docs/screenshots/800x800 2.jpg) **Лица** — ручная разметка зон для CodeFormer |
